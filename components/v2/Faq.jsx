      ...
      <div className="container mx-auto px-4 max-w-3xl relative flex flex-col items-center">
        ...
        <Accordion type="single" collapsible className="w-full max-w-2xl space-y-3 mx-auto">
          {faqs.map((faq, i) => (
            ...
            >
              <AccordionTrigger className="text-right text-white font-semibold text-base md:text-lg p-4 md:p-5 hover:no-underline hover:text-purple-300 transition-colors duration-300 flex items-center gap-3 w-full cursor-pointer [&[data-state=open]]:pb-0">
              ...
              <AccordionContent className="p-4 md:p-5 pt-0 text-gray-300 text-sm md:text-base leading-relaxed mr-9">
                {faq.a}
              </AccordionContent>
            </AccordionItem>
          ))}
